<div id="main-menu" class="skrollable">
	...
	<div class="menu-container">
		<ul class="nav">
			...
			<li><a href="#section-projects" {{ HomeController::getMenuParams('projects', $skrollrData['projects']) }}>Projetos</a></li>
			<li><a href="#">Soluções</a></li>
			<li><a href="#section-clients" {{ HomeController::getMenuParams('clients', $skrollrData['clients']) }}>Clientes</a></li>
